...
compiled = joinpath(depot, match(r"^\d+\.\d+", string(VERSION)).match)
rm(joinpath(compiled, "v1.6", "Maple"), force = true, recursive = true)
rm(joinpath(compiled, "v1.6", "Ahorn"), force = true, recursive = true)
